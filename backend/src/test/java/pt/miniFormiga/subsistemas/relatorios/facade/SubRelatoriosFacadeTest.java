...
import pt.miniFormiga.subsistemas.sincronizacao.service.IConsultaSincronizacao;
...
class SubRelatoriosFacadeTest {
    ...
    void exportacaoPdfStockMostraNomeDaLojaEmVezDoIdentificador() {
        when(stockStore.listar(loja.getId())).thenReturn(List.of(
                new pt.miniFormiga.subsistemas.stock.service.StockItem(produto, loja.getId(), loja.getNome(), 5, 10, null, null, null, null)
        ));
